...
CREATE USER dvmi WITH ENCRYPTED PASSWORD 'ciscosecpa55';
GRANT ALL PRIVILEGES ON DATABASE cti_2024 TO dvmi ;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO dvmi;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO dvmi;